...
func (r *PGOrderRepository) Add(ctx context.Context, order *model.Order) error {
...
func (r *PGOrderRepository) GetByUser(ctx context.Context, userID int) ([]model.Order, error) {
...
func (r *PGOrderRepository) GetByNumber(ctx context.Context, number string) (*model.Order, error) {
	var order model.Order
	err := r.db.QueryRowContext(ctx,
...
func (r *PGOrderRepository) GetPending(ctx context.Context) ([]model.Order, error) {
	rows, err := r.db.QueryContext(ctx,
